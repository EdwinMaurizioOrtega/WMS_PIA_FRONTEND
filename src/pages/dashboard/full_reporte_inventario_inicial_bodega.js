...
FullReporteInventarioInicialBodega.getLayout = (page) => <DashboardLayout>{page}</DashboardLayout>;

// ----------------------------------------------------------------------

export default function FullReporteInventarioInicialBodega() {
    ...
    const handleClick = async () => {
            ...
            const url = `${HOST_API_KEY}/api/wms/full_reporte_inventario_inicial_bodega`;
